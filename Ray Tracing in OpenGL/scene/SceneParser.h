...
class SceneParser
{
   public:
      ...
      std::vector<struct RenderedPrimitive> getFlattenedTree();
   ...
   private:
      ...
      void flatten();
      void flattenSceneNode(SceneNode* node, glm::mat4 currentMatrix);
      ...
      std::vector<struct RenderedPrimitive> flattenedTree;
};
